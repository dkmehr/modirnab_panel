  ...
  return (
    <>
      {/* <div className="customerTab">
        <small
          className={userTab === 0 ? "active" : ""}
          onClick={() => setUserTab(0)}
        >
          اطلاعات اصلی
        </small>
        <small
          className={userTab === 1 ? "active" : ""}
      ...
      <div className="card-form">
        {userTab ? (
          <CustomerXtra setData={props.setData} def={def} />
        ) : (
          <div className="card-input">
            ...
            <StyleInput
              ...
              class="userInput"
              defaultValue={
                props.phoneUser ? props.phoneUser : def ? def.phone : ""
              }
              action={(e) =>
                props.setData((prevState) => ({
                  ...prevState,
            ...
            <StyleInput
              ...
              direction={"rtl"}
              class="userInput"
              defaultValue={def ? def.postalCode : ""}
              action={(e) =>
                props.setData((prevState) => ({
                  ...prevState,
                  postalCode: e,
            ...
            <StyleInput
              title={"آدرس"}
              direction={"rtl"}
              class="userInput fullRow"
              defaultValue={def ? def.Address : ""}
              action={(e) =>
                props.setData((prevState) => ({
                  ...prevState,
                  Address: e,
            ...
            {/* <div className="imageUser">
              <ImageUserHolder
                imageUrl={
                  props.imageUrl ? props.imageUrl : def ? def.imageUrl1 : ""
                }
                setImageUrl={props.setImageUrl}
                imageUrl2={
                  props.imageUrl2 ? props.imageUrl2 : def ? def.imageUrl2 : ""
                }
                ...
                init={0}
                def={def}
                titles={["تصویر کارت ملی*", "تصویر کد نقش", "تصویر جواز کسب"]}
              />
            </div>
            <div className="imageUser">
              <ImageUserHolder
                imageUrl={
                  props.shopUrl1 ? props.shopUrl1 : def ? def.shopUrl1 : ""
                }
                setImageUrl={props.setShopUrl1}
                imageUrl2={
                  props.shopUrl2 ? props.shopUrl2 : def ? def.shopUrl2 : ""
                }
                setImageUrl2={props.setShopUrl2}
                kasbUrl={
                  props.shopUrl3 ? props.shopUrl3 : def ? def.shopUrl3 : ""
                }
                setKasbUrl={props.setShopUrl3}
                init={10}
                def={def}
                titles={[
                  "تصویر محل کسب 2",
